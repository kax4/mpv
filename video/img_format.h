...
enum mp_imgfmt {
    ...
    IMGFMT_RGBA64  = IMGFMT_RGBA64_BE,
    IMGFMT_BGRA64  = IMGFMT_BGRA64_BE,
    ...
    IMGFMT_444AP16 = IMGFMT_444AP16_BE,
    IMGFMT_444AP10 = IMGFMT_444AP10_BE,
    IMGFMT_444AP9  = IMGFMT_444AP9_BE,

    IMGFMT_422AP16 = IMGFMT_422AP16_BE,
    IMGFMT_422AP10 = IMGFMT_422AP10_BE,
    IMGFMT_422AP9  = IMGFMT_422AP9_BE,

    IMGFMT_420AP16 = IMGFMT_420AP16_BE,
    IMGFMT_420AP10 = IMGFMT_420AP10_BE,
    IMGFMT_420AP9  = IMGFMT_420AP9_BE,

    IMGFMT_Y16     = IMGFMT_Y16_BE,

    IMGFMT_GBRP9   = IMGFMT_GBRP9_BE,
    IMGFMT_GBRP10  = IMGFMT_GBRP10_BE,
    IMGFMT_GBRP12  = IMGFMT_GBRP12_BE,
    IMGFMT_GBRP14  = IMGFMT_GBRP14_BE,
    IMGFMT_GBRP16  = IMGFMT_GBRP16_BE,
#else
    ...
    IMGFMT_RGBA64  = IMGFMT_RGBA64_LE,
    IMGFMT_BGRA64  = IMGFMT_BGRA64_LE,
    ...
    IMGFMT_444AP16 = IMGFMT_444AP16_LE,
    IMGFMT_444AP10 = IMGFMT_444AP10_LE,
    IMGFMT_444AP9  = IMGFMT_444AP9_LE,

    IMGFMT_422AP16 = IMGFMT_422AP16_LE,
    IMGFMT_422AP10 = IMGFMT_422AP10_LE,
    IMGFMT_422AP9  = IMGFMT_422AP9_LE,

    IMGFMT_420AP16 = IMGFMT_420AP16_LE,
    IMGFMT_420AP10 = IMGFMT_420AP10_LE,
    IMGFMT_420AP9  = IMGFMT_420AP9_LE,

    IMGFMT_Y16     = IMGFMT_Y16_LE,

    IMGFMT_GBRP9   = IMGFMT_GBRP9_LE,
    IMGFMT_GBRP10  = IMGFMT_GBRP10_LE,
    IMGFMT_GBRP12  = IMGFMT_GBRP12_LE,
    IMGFMT_GBRP14  = IMGFMT_GBRP14_LE,
    IMGFMT_GBRP16  = IMGFMT_GBRP16_LE,
#endif
};
